...
const STRINGS = {
  en: {
    ...
    // Portfolio
    portfolio: "Portfolio",
    portfolioTagline: "Savings and investments in one place.",
    netWorth: "Net worth",
    ...
    autoBadge: "auto",
    autoCashHint:
      "Each time a cycle ends, its surplus (income − spending) is added here automatically.",
    addAccount: "Add account",
    accountNamePlaceholder: "e.g. Emergency fund",
    balance: "Balance",
    confirmDeleteAccount: "Delete this account?",
    netWorthHistory: "Net worth history",
    noHistoryYet: "History appears after your first completed cycle.",
    portfolioApiDown: "Couldn't load positions — showing the last snapshot.",
    portfolioApiDownNoData: "Couldn't load positions from your API.",
    portfolioNotConfigured: "Add your portfolio API URL in Settings to see your positions here.",
    asOf: "as of {date}",

    // Settings: portfolio API
    portfolioApiTitle: "Portfolio API",
    portfolioApiHint:
      "GET endpoint that returns your positions. Called with your API key as a Bearer token; prices must be in EUR.",
  ...
  bg: {
    ...
    // Portfolio
    portfolio: "Портфолио",
    portfolioTagline: "Спестявания и инвестиции на едно място.",
    netWorth: "Нетна стойност",
    investments: "Инвестиции",
    savingsLabel: "Спестявания",
    ...
    profitLoss: "П/З",
    allocShare: "Дял",
    noPositions: "Още няма позиции.",
    otherSlice: "Друго",
    savingsAccounts: "Спестовни сметки",
    cashAccount: "Кеш",
    autoBadge: "авто",
    autoCashHint:
      "В края на всеки период излишъкът (доход − харчове) се добавя тук автоматично.",
    addAccount: "Добави сметка",
    accountNamePlaceholder: "напр. Авариен фонд",
    balance: "Салдо",
    confirmDeleteAccount: "Изтрий тази сметка?",
    netWorthHistory: "История на нетната стойност",
    noHistoryYet: "Историята се появява след първия завършен период.",
    portfolioApiDown: "Позициите не се заредиха — показва се последният запис.",
    portfolioApiDownNoData: "Позициите не се заредиха от твоето API.",
    portfolioNotConfigured: "Добави URL на портфолио API в Настройки, за да виждаш позициите си тук.",
    asOf: "към {date}",

    // Settings: portfolio API
    portfolioApiTitle: "Портфолио API",
    portfolioApiHint:
      "GET endpoint, който връща позициите ти. Вика се с твоя API ключ като Bearer токен; цените трябва да са в EUR.",
    portfolioApiUrlPlaceholder: "https://example.com/positions",
